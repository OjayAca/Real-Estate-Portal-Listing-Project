...
- Buyer saved listings and inquiry submission.
- Agent listing management and inquiry response workflow.
- Admin user, agent, and property oversight.
- Notification dropdown and popup alerts in the frontend.
